...
class MailDocumentVersionViewsTestCase(
    DocumentVersionMailerViewTestMixin, MailerTestMixin, GenericDocumentViewTestCase
):
    def test_document_version_send_link_view_no_permission(self):
        ...
        response = self._request_test_document_version_send_link_view()
    ...
    def test_document_version_send_link_view_with_access(self):
        self._create_test_user_mailer()
    ...
    def test_trashed_document_version_send_link_view_with_access(self):
        self._create_test_user_mailer()
    ...
    def test_document_version_send_view_no_permission(self):
        self._create_test_user_mailer()
        ...
        response = self._request_test_document_version_send_view()
        self.assertEqual(response.status_code, 404)
    ...
    def test_document_version_send_view_with_access(self):
        self._create_test_user_mailer()
    ...
    def test_trashed_document_version_send_view_with_access(self):
        self._create_test_user_mailer()
